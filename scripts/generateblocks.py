...
def generate_site():
    ...
    <div style="float:left; margin-left:10px; margin-right:10px;"><i><a href="mapa_impr.html">Página para impressão</a></i></div>
    <br>
...
site_header = """<html>
  <head>
	<meta charset="utf-8">
	<title>Pontual Import Brindes - Pontual Exportação e Importação Ltda.</title>
...
{sidebar}
    ...
    <br>
        <div style="float:left; margin-left:10px; margin-right:10px;"><i><a href="pr_{id}_impr.html">Página para impressão</a></i></div>
    <br>
