...
def generate_site():
    ...
    <div style="float:left; margin-right:10px;"><i><a href="mapa_impr.html">Página para impressão</a></i></div>
    <br>
...
{sidebar}
    ...
    <br>
        <div style="float:left; margin-right:10px;"><i><a href="pr_{id}_impr.html">Página para impressão</a></i></div>
    <br>
